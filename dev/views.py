...
def setup_dummy_data(request):
    ...
    course_instance1, create = CourseInstance.objects.get_or_create(course=course1, session=session1, max_enrollees=10)
    course_instance2, create = CourseInstance.objects.get_or_create(course=course1, session=session2, max_enrollees=10)
    course_instance3, create = CourseInstance.objects.get_or_create(course=course1, session=session4, max_enrollees=10)
    course_instance4, create = CourseInstance.objects.get_or_create(course=course2, session=session1, max_enrollees=10)
    course_instance5, create = CourseInstance.objects.get_or_create(course=course2, session=session3, max_enrollees=10)
    course_instance6, create = CourseInstance.objects.get_or_create(course=course3, session=session2, max_enrollees=10)
    course_instance7, create = CourseInstance.objects.get_or_create(course=course3, session=session3, max_enrollees=10)
    course_instance8, create = CourseInstance.objects.get_or_create(course=course3, session=session4, max_enrollees=10)
